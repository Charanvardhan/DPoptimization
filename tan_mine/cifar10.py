...
DEFAULT_DUMP_PATH = "/home/myid/crm54892/results/resnet10"  # Replace with a valid directory path
DEFAULT_EXP_NAME = "rmsprop5"
...
def run_single_experiment(config, exp_id):  ## for non poisson, divide bs by world size
    ...
    model = resnet20()
    # model = WideResNet(16,10,4,args.nb_groups,args.init,args.order1,args.order2)
...
def main():
    config_file = "config_rmsprop.yaml"  # Path to YAML file
